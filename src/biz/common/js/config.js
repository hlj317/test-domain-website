...
const config  = {
	...
	text3: () => "抱歉！您竞猜的次数已用完！",
	text4: () => "点击右上角，分享好友助力成功后，增加<em>1</em>次机会！",
	text5: () => "助力成功！",
	text6: () => "赠送您 <em>5次</em> 猜价格的机会！",
	text7: (data) => `您猜的价格是<em>${data.price}</em>元，<em>${data.result}</em>！恭喜您！`,
	text8: () => "但可惜您来晚了一步，实物奖品已被抢完啦！",
	text9: () => "赠送您3元现金券一张，可用于<em>624大牌洗护节</em>！",
	text10: () => "很遗憾，您不是新用户，无法助力！",
	text11: () => "您好，只有<em>新用户</em>才能在微信中参与猜价格游戏！",
	text12: () => "<em>请打开贝贝APP<em>参加猜价格赢大礼包活动！",
	text13: (data) => `您的朋友 <em>${data.user}</em> 正在玩猜价格赢大礼的游戏！`,
	text14: () => "您的助力可以帮助他多增加一次竞猜的机会！",
	text15: () => "需要分享给微信好友，助力成功即可多增加<em>1</em>次机会！",
	text18: () => "网络错误，请重试。",
	text19: (data) => `现在您还有<em>${data.count}</em>次猜价格赢大礼的机会！`,
	text20: () => "助力成功！但您竞猜的次数已用完！",
};
// 弹窗内容
const components = {
	// 价格低了
